...
$pagename = "Tracking, CCTV and Telematics"; ?>
<main>
          ...
          <div class="row">
            ...
            <div class="row row-fit-lg" data-anima="fade-bottom" data-time="1000">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="title">
                        <h2>Telematics</h2>
                        <p>CCTV, TRACKING, MONITORING and IOT</p>
                    </div>
                    <p>
                      We provide enhanced tele-security systems for all kinds of mobile and stationery properties.
                      Leveraging the power of Internet of Things (IOT), realtime transmission of computerized data / information
                      about properties is remotely available.
                    </p>
                    <p>
                      <b>Areas of impact:</b>
                      <ul>
